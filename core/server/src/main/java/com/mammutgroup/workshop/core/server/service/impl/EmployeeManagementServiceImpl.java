 ...
 */
@Service
public class EmployeeManagementServiceImpl extends BaseCrudServiceImpl<EmployeeEntity, EmployeeDto, Long, EmployeeApi>
        implements EmployeeManagementService {
}
